...
export class JaipurComponent implements OnInit {
  ...
  public places=[
    {name : "Amber Fort" , weather:"24° C", timings : "9:00 AM - 6:00 PM " , timer:"3-4 hours" , fee:"INR 25" , 
      ...
      {name : "Nahargarh Fort" , weather:"24° C", timings : "10:00 AM - 5:30 PM" , timer:"2-3 hours" , fee:"INR 20" , 
      ...
      {name : "Hawa Mahal" , weather:"24° C", timings : "9:00 AM - 4:30 PM" , timer:"1 hours" , fee:"INR 50 " , 
      ...
      {name : "City Palace" , weather:"24° C", timings : "9:30 AM - 5:00 PM" , timer:"2-3 hours" , fee:"INR 100" , 
      ...
      {name : "Jantar Mantar Jaipur" , weather:"24° C", timings : "9:00 AM - 4:30 PM" , timer:"1-2 hours" , fee:"INR 40" , 
      ...
      {name : "Lacchiwalla" , weather:"18° C", timings : "8 AM to 5 PM " , timer:"" , fee:"INR 20 " , 
      imgS:"https://images.app.goo.gl/ognPq9NTkxTakRsM6",  decs :"A popular picnic destination, Lacchiwalla is famous for its lush greenery unspoiled by human activity. It is located at a small drive away from Dehradun. You can stay over at picturesque cottages and hotels." }
  ]
  index : number;
